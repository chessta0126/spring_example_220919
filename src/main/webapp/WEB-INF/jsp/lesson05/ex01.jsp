...
<body>
	...
	<c:set var="number1" value="100"/> <%-- 권장 --%>
	number1: ${number1}<br>
	...
	<%-- 문구 그대로 출력된다. --%>
	<c:out value="<script>alert('alert 창 띄우기');</script>" escapeXml="true"/>
	<%-- 스크립트가 수행된다. --%>
	<c:out value="<script>alert('alert 창 띄우기');</script>" escapeXml="false"/>
