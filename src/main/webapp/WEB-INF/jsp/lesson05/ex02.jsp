...
<body>
	...
	<c:forEach begin="0" end="5" step="1" var="val1"><%-- end는 등호 포함 --%>
		${val1}<br>
	</c:forEach>
	...
	<%-- java의 for-each -> for(항목 : List) --%>
	<c:forEach var="fruit" items="${fruits}" varStatus="status"> <%-- var와 items 이름 같게 하면 안 된다. --%>
